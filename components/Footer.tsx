...
const Footer = () => {
    return (
        <footer className='relative border-t border-gray-800 w-full'>
            <div className='w-full px-4 sm:px-6 lg:px-8 py-12 sm:py-16'>
                {/* Gradient Overlay - Dark in dark mode, Light in light mode */}
                <div className='absolute inset-0 bg-gradient-to-t from-black/10 dark:from-black via-transparent to-transparent pointer-events-none' />
                    ...
                    <div className='text-center sm:text-left'>
                        ...
                        <div className='space-y-3'>
                            ...
                            <div className='flex items-center justify-center sm:justify-start gap-2 text-gray-400 hover:text-white transition-colors'>
                                ...
                                <a href="mailto:sivatheevan1224@gmail.com" className='hover:text-blue-400 transition-colors'>
                                    sivatheevan1224@gmail.com
                                </a>
                            </div>
                        </div>
                    </div>
